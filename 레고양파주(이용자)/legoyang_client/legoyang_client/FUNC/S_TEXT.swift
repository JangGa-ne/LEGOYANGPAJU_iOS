...
// 줄간격
    func lineSpacing(text: String = "", lineSpacing: CGFloat) -> NSAttributedString {
    ...
    func STRING_WIDTH(TEXT: String, FONT_SIZE: CGFloat) -> CGFloat {
        return NSAttributedString(string: TEXT, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: FONT_SIZE)]).size().width
    }
